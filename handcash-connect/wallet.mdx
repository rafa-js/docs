...
Checks the user's spendable balance.  The user authorizes the amount an app can spend daily by default this value is $10 per day. Users can adjust this limit at https://market.handcash.io
