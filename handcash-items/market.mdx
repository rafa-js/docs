...
The [Handcash Market](https://market.handcash.io) is a feature-rich item marketplace that provides an excellent user experience for games to leverage. It allows item creators to earn a 5% commission on each item listing, while Handcash takes a 4% cut.
